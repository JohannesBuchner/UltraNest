...
def build_tree(theta, r, grad, v, j, epsilon, invmassmatrix, f, joint0):
    ...
    if j == 0:
        ...
        thetaminus, rminus, gradminus, thetaplus, rplus, gradplus, thetaprime, gradprime, logpprime, extraprime, rprime, sprime, alphaprime, betaprime, nalphaprime = build_tree(theta, r, grad, v, j - 1, epsilon, invmassmatrix, f, joint0)
...
def tree_sample(theta, logp, r0, grad, extra, epsilon, invmassmatrix, f, joint, maxheight=np.inf):
    ...
    while s and j < maxheight:
        ...
        if v == -1:
            thetaminus, rminus, gradminus, _, _, _, thetaprime, gradprime, logpprime, extraprime, rprime, sprime, alphaprime, betaprime, nalphaprime = build_tree(
