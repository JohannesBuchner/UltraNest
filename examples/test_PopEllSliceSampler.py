...
def main(args):
    ...
    if args.PopSlice:
        import ultranest.popstepsampler as ultrapop
        direction=[ultrapop.generate_cube_oriented_direction,ultrapop.generate_random_direction, ultrapop.generate_region_oriented_direction, ultrapop.generate_region_random_direction]
        sampler.stepsampler = ultrapop.PopulationSliceSampler(popsize=args.popsize,nsteps=args.nstep,generate_direction=direction[1],scale=1.0)
    if args.Slice:
    ...
    if args.PopGaussWalk:
        import ultranest.popstepsampler as ultrapop
        direction=[ultrapop.generate_cube_oriented_direction,ultrapop.generate_random_direction, ultrapop.generate_region_oriented_direction, ultrapop.generate_region_random_direction]
        sampler.stepsampler = ultrapop.PopulationRandomWalkSampler(popsize=args.popsize, nsteps=args.nstep, generate_direction=direction[1],scale=1.0,)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ElliSlice', action='store_true')
